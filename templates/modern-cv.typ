...
Especialista em dados com mais de 20 anos de experiência, liderando projetos de BI, IA, engenharia e modernização de dados em grandes empresas nacionais e multinacionais. Tenho histórico comprovado em migração de mais de 56TB de dados em tempo recorde utilizando arquitetura medallion, IA, automação, Google Cloud, Dataproc e gestão de projetos ágeis.
